/******/ ;(() => {
  ...
  \****************************/
            /***/ (
                ...
                /* harmony export */ __webpack_require__.d(
                    __webpack_exports__,
                    {
                        /* harmony export */ renderGameClose: () =>
                            /* binding */ renderGameClose,
                        /* harmony export */
                    }
                )
                /* harmony import */ var _cards__WEBPACK_IMPORTED_MODULE_0__ =
                    __webpack_require__(/*! ./cards */ "./cards.ts")
                /* harmony import */ var _game_page__WEBPACK_IMPORTED_MODULE_1__ =
                    __webpack_require__(/*! ./game-page */ "./game-page.ts")
                    ...
                    if (level === "1") {
                        appHtml =
                            '\n    <div class="body game">\n        <div class="game-header">\n            <div class="time">\n                <div class="time__block">\n                    <p class="time-name">min</p> \n                    <p class="min-value">00</p>\n                </div>\n                <div class="time__block">\n                    <p class="time-name">sek</p> \n                    <p class="sek-value">.00</p>\n                </div>\n            </div>\n            <button class="button-start">\u041D\u0430\u0447\u0430\u0442\u044C \u0437\u0430\u043D\u043E\u0432\u043E</button>\n        </div>\n        <ul class="game-zone-1">\n            <li class="game__card" data-id="'
                                .concat(
                                    _game_page__WEBPACK_IMPORTED_MODULE_1__
                                        .cardsGame[0].id,
                                    '" data-index=0>\n                <img class="game-card"  src="'
                                )
                                .concat(
                                    _cards__WEBPACK_IMPORTED_MODULE_0__.cards[0]
                                        .img,
                                    '" alt="1">\n            </li>\n            <li class="game__card" data-id="'
                                )
                                .concat(
  ...
  \**********************/
            /***/ (
                ...
                /* harmony export */ __webpack_require__.d(
                    __webpack_exports__,
                    {
                        /* harmony export */ cardsGame: () =>
                            /* binding */ cardsGame,
                        /* harmony export */ cardsGameFirst: () =>
                            /* binding */ cardsGameFirst,
                ...
                function renderGame(level) {
                    ...
                    if (level === "1") {
                        while (cardsGameFirst.length < 3) {
                            ...
                            if (
                                !cardsGameFirst.includes(
                                    _cards__WEBPACK_IMPORTED_MODULE_0__.cards[
                                        index
                                    ]
                                )
                            ) {
  ...
  \*****************/
            /***/ (
                ...
                /* harmony import */ var _game_page_close__WEBPACK_IMPORTED_MODULE_0__ =
                    __webpack_require__(
                        /*! ./game-page-close */ "./game-page-close.ts"
                    )
                /* harmony import */ var _cards__WEBPACK_IMPORTED_MODULE_1__ =
                    __webpack_require__(/*! ./cards */ "./cards.ts")
                /* harmony import */ var _game_page__WEBPACK_IMPORTED_MODULE_2__ =
                    __webpack_require__(/*! ./game-page */ "./game-page.ts")
                /* harmony import */ var _script__WEBPACK_IMPORTED_MODULE_3__ =
                    __webpack_require__(/*! ./script */ "./script.ts")

                function game() {
                    _script__WEBPACK_IMPORTED_MODULE_3__.appEl.innerHTML = (0,
                    _game_page__WEBPACK_IMPORTED_MODULE_2__.renderGame)(
                        window.application.level
                    )
                    setTimeout(function () {
                        _script__WEBPACK_IMPORTED_MODULE_3__.appEl.innerHTML =
                            (0,
                            _game_page_close__WEBPACK_IMPORTED_MODULE_0__.renderGameClose)(
                                window.application.level
                            )
                        var cardElements =
                                ...
                                if (
                                    ...
                                    cardElement.innerHTML =
                                        '<img class="game-card" src="'.concat(
                                            _cards__WEBPACK_IMPORTED_MODULE_1__
                                                .cards[firstCard].img,
                                            '" alt="1"></img>'
                                        )
                                    ...
                                    if (
                                        ...
                                        if (
                                            count ===
                                            _game_page__WEBPACK_IMPORTED_MODULE_2__
                                                .cardsGameFirst.length
                                        ) {
                                            ...
                                            buttonFinish === void 0
                                                ...
                                                : buttonFinish.addEventListener(
                                                      ...
                                                      function () {
                                                          ;(0,
                                                          _script__WEBPACK_IMPORTED_MODULE_3__.renderApp)()
                                                      }
                                                  )
                                        }
                                    } else if (
                                        ...
                                        countGame++
                                        if (
                                            countGame > window.application.level
                                        ) {
                                            winner = false
                                            _script__WEBPACK_IMPORTED_MODULE_3__.appEl.innerHTML =
                                                renderFinish(winner)
                                        ...
                                        var cardsEl = document.querySelectorAll(
                                            '[data-id="'.concat(firstCard, '"]')
                                        )
                                        for (
                                            var _i = 0, cardsEl_1 = cardsEl;
                                            _i < cardsEl_1.length;
                                            _i++
                                        ) {
                                            var i = cardsEl_1[_i]
                        ...
                        for (
                            var _i = 0, cardElements_1 = cardElements;
                            _i < cardElements_1.length;
                            _i++
                        ) {
                        ...
                        function updateTime() {
                            ...
                            sek.textContent = ".".concat(
                                seconds.toString().padStart(2, "0")
                            )
                            min.textContent = "".concat(
                                minutes.toString().padStart(2, "0")
                            )
                        }
                    }, 3000)
  ...
  \*******************/
            /***/ (
                ...
                /* harmony import */ var _game__WEBPACK_IMPORTED_MODULE_1__ =
                    __webpack_require__(/*! ./game */ "./game.ts")
                ...
                function renderApp() {
                    ...
                    startButton === null || startButton === void 0
                        ...
                        : startButton.addEventListener("click", function () {
                              ...
                              for (
                                  var _i = 0, levelElements_1 = levelElements;
                                  _i < levelElements_1.length;
                                  _i++
                              ) {
